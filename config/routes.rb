...
Rails.application.routes.draw do
  ...
  resources :purchase_orders do
    collection do
      ...
      get 'version', to: 'purchase_orders#version'
    end
    member do
  ...
  resources :system_users do
    collection do
      ...
      post 'import_supplier_locations', to: 'system_users#import_supplier_locations'
      get 'export_supplier_product_csv', to: 'system_users#export_supplier_product_csv'
    end
  end
  ...
  resources :order_dispatches do
    collection do
      ...
      post 'return_order', to: 'order_dispatches#return_order'
      ...
      post 'create_manual_order', to: 'order_dispatches#create_manual_order'
      get 'replacement_order_confirm', to: 'order_dispatches#replacement_order_confirm'
    end
  end
  ...
  resources :pick_and_packs do
    collection do
      ...
      get 'print_picklist_queue', to: 'pick_and_packs#print_picklist_queue'
  ...
  resources :order_batches do
    collection do
      ...
      get 'reprint', to: 'order_batches#reprint'
    end
  end
  ...
  resources :sellings do
    collection do
      ...
      get 'amazon_selling', to: 'sellings#amazon_selling'
    end
  end
  ...
  put 'printer', to: 'printers#update'
  ...
  namespace :api do
    namespace :v1 do
      get 'download_file', to: 'printers#download_file'
      post 'update_printers', to: 'printers#update_printers'
      get 'available_printers', to: 'printers#available_printers'
    end
  end
end
